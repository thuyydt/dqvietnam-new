...
<?php else : ?>
    <title><?php echo $this->info->get('siteName')?></title>
    <meta name="description"
          content="<?php echo $this->info->get('metaDescription'); ?>"/>
    <meta name="keywords"
          content="<?php echo $this->info->get('metaKeyword') ?>"/>
...
<link rel="icon"
      href="<?= $this->info->get('favicon', base_url("/public/favicon.ico")); ?>"
      sizes="32x32">
<link rel="icon"
      href="<?= $this->info->get('favicon', base_url("/public/favicon.ico")); ?>"
      sizes="192x192">
...
<meta name="msapplication-TileImage"
      content="<?= $this->info->get('favicon', base_url("/public/favicon.ico")); ?>">
