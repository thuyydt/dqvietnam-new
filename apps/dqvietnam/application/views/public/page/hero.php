<main>
  ...
  <section class="c-section__dp-hero-01">
    <div class="container">
      <div class="row">
        <div class="col-12 col-lg-6 left">
          <img class="logo" src="./public/images/logo-02.png" loading="lazy" />
        </div>
        <div class="col-12 col-lg-6 right">
          <div class="inner">
            <img src="./public/images/element-13.png" loading="lazy" />
  ...
  <section class="c-section__dp-hero-02">
    <div class="container">
      <div class="group">
        <figure class="item">
          <div class="inner">
            <div class="img"><img class="ic ic-01" src="./public/images/element-16.png" loading="lazy" /></div>
        ...
        <figure class="item">
          <div class="inner">
            <div class="img"><img class="ic ic-02" src="./public/images/element-17.png" loading="lazy" /></div>
        ...
        <figure class="item">
          <div class="inner">
            <div class="img"><img class="ic ic-03" src="./public/images/element-18.png" loading="lazy" /></div>
  ...
  <section class="c-section__dp-hero-03">
    <div class="container">
      <div class="row">
        <div class="col-12 col-lg-7">
          <img src="./public/images/element-19.png" class="bg" loading="lazy" />
        </div>

        <div class="col-12 col-lg-5 align-items-center">
          <div class="content">
            Bằng cách hoàn thành chương trình học trên Người hùng DQ, con bạn có thể:
            <ul>
              <li>Phát triển sự hiểu biết về thế giới kỹ thuật số</li>
              <li>Khám phá những hành vi tích cực cần thiết để trở nên tử tế và tôn trọng trên mạng.</li>
              <li>Kiểm tra rủi ro trực tuyến, hành vi tiêu cực và tin tức giả mạo.</li>
              <li>Học cách tìm kiếm sự giúp đỡ và phục hồi sau sự cố.</li>
            </ul>
          </div>
        </div>
      </div>
  ...
  <section class="c-section__dp-hero-04">
    <div class="container">
      <div class="heading">
        <h2>TẠI SAO TRẺ EM CẦN ĐƯỢC TRANG BỊ<br>TRÍ THÔNG MINH KỸ THUẬT SỐ (DQ)</h2>
      </div>
      <div class="row">
        ...
        <div class="col-12 col-lg-6 box-1">
          <div class="content-item">
            <img src="./public/images/ic-9.png" class="icon" loading="lazy" />
            <div class="inner">
          ...
          <div class="content-item">
            <img src="./public/images/ic-10.png" class="icon" loading="lazy" />
            <div class="inner">
          ...
          <div class="content-item">
            <img src="./public/images/ic-11.png" class="icon" loading="lazy" />
            <div class="inner">
        ...
        <div class="col-12 box-2">
          <div class="content-item">
            <img src="./public/images/ic-12.png" class="icon" loading="lazy" />
            <div class="inner">
          ...
          <div class="content-item">
            <img src="./public/images/ic-13.png" class="icon" loading="lazy" />
            <div class="inner">
          ...
          <div class="content-item">
            <img src="./public/images/ic-14.png" class="icon" loading="lazy" />
            <div class="inner">
