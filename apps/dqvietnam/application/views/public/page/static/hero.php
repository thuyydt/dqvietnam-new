...
<main class="hero-page">
  <section class="banner">
    <?php if ($hero_banner) { ?>
      <img src="<?php echo $hero_banner ?>" alt="Banner Người Hùng DQ" fetchpriority="high" />
    <?php } else { ?>
      <img src="public/images/dqlagi/banner.webp" alt="Banner Người Hùng DQ" fetchpriority="high" />
    <?php } ?>
  </section>
  <section class="section what">
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6">
          <img src="public/images/dqlagi/1.webp" alt="Trẻ em gặp rủi ro trên mạng" loading="lazy" decoding="async" />
        </div>
        <div class="row padding-top-24">
          <div class="col-lg-6">
            <img src="public/images/dqlagi/ipad.webp" alt="Trẻ em sử dụng iPad" loading="lazy" decoding="async" />
          </div>
          <div class="col-lg-6">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-4">
          ...
          <a href="<?= urlRoute('guide?type=try_game') ?>" class="btn btn-02" title="Trải nghiệm ngay">TRẢI NGHIỆM</a>
        </div>
        <div class="col-lg-8">
          <div class="row">
            <div class="col-lg-4 img-wrap">
              <img class="pp-img" src="public/images/dqlagi/pp1.webp" alt="Series hoạt hình sinh động" srcset="" loading="lazy" decoding="async" />
              <div class="img-desc">
                • Series hoạt hình sinh động với đồ họa đặc sắc
              </div>
            </div>
            <div class="col-lg-4 img-wrap">
              <img class="pp-img" src="public/images/dqlagi/pp2.webp" alt="Trò chơi tương tác hấp dẫn" srcset="" loading="lazy" decoding="async" />
              <div class="img-desc">• Trò chơi tương tác hấp dẫn</div>
            </div>
            <div class="col-lg-4 img-wrap">
              <img class="pp-img" src="public/images/dqlagi/pp3.webp" alt="Trắc nghiệm tình huống đa dạng" srcset="" loading="lazy" decoding="async" />
      ...
      <div class="mohinh">
        ...
        <div class="row">
          <div class="col-lg-4 item-step">
            <img src="public/images/dqlagi/pp4.webp" alt="Học trước trên E-Learning" srcset="" loading="lazy" decoding="async" />
          ...
          <div class="col-lg-4 item-step">
            <img src="public/images/dqlagi/pp5.webp" alt="Thảo luận" srcset="" loading="lazy" decoding="async" />
          ...
          <div class="col-lg-4 item-step">
            <img src="public/images/dqlagi/pp6.webp" alt="Thực hành" srcset="" loading="lazy" decoding="async" />
            <div class="img-desc">
        ...
        <div class="card-group">
          <div class="wrap-card">
            ...
            <div class="card-content">
              <img src="public/images/dqlagi/card.webp" alt="Công Cụ Học Tập" loading="lazy" decoding="async" />
            </div>
          </div>
          <div class="wrap-card">
            <div class="card-content shadow-card">
            ...
            <div class="card-content">
              <img src="public/images/dqlagi/card2.webp" alt="Tầm soát rủi ro" srcset="" loading="lazy" decoding="async" />
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-4 give-item">
          <img class="img-loiich" src="public/images/dqlagi/loiich1.webp" alt="Lợi ích cho trẻ" loading="lazy" decoding="async" />
          <ul class="give-item-content shadow-card-blur">
            <li class="item-list">
              <img class="icon-check" src="public/images/dqlagi/icon-check.webp" alt="Check" srcset="" loading="lazy" decoding="async" />
        ...
        <div class="col-lg-4 give-item">
          <img class="img-loiich" src="public/images/dqlagi/loiich2.webp" alt="Phát triển tư duy" loading="lazy" decoding="async" />
          <ul class="give-item-content shadow-card-blur">
            <li class="item-list">
              <img class="icon-check" src="public/images/dqlagi/icon-check.webp" alt="Check"
                srcset="" loading="lazy" decoding="async" />
        ...
        <div class="col-lg-4 give-item">
          <img class="img-loiich" src="public/images/dqlagi/loiich3.webp" alt="Hỗ trợ phụ huynh" loading="lazy" decoding="async" />
          <ul class="give-item-content shadow-card-blur">
            <li class="item-list">
              <img class="icon-check" src="public/images/dqlagi/icon-check.webp" alt="Check"
                srcset="" loading="lazy" decoding="async" />
  ...
  <section class="section countdown">
    <div class="container flex-top-center">
      <div class="wrap-countdown text-center">
        <a style="margin-top: 200px" href="https://docs.google.com/forms/d/e/1FAIpQLSdb79Q6Sm9ASZq8_RptQDsrhJlqMlgHU2MumLST3CfeRMt1Sw/viewform" target="_blank" rel="noopener noreferrer" class="btn-register" title="Đăng ký học ngay">ĐĂNG KÝ HỌC</a>
      </div>
    </div>
  </section>
</main>
