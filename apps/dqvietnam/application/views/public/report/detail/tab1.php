<?php
$isAnswerTrue = $keyAnswer ? str_contains(mb_strtolower($keyAnswer['title']), 'dưới 2 giờ') : false;
?>
<div class="task-detail">
    ...
    <div class="row align-items-center mt-5">
        ...
        <div class="col-md-12">
            <p class="title text-bold mb-4">Thời gian sử dụng màn hình điện tử của trẻ
                là: <?= $keyAnswer['title'] ?? '....' ?></p>
        </div>
        <div class="col-md-8">
            <?php if ($isAnswerTrue): ?>
                <p class="txt">
                    Thời gian tiếp xúc màn hình của trẻ là <?= strtolower($keyAnswer['title']) ?? '....' ?>. Trẻ đã biết
                    cách kiểm soát thời
                    gian
                    khi tiếp
            ...
            <?php else: ?>
                <p class="txt">Thời gian tiếp xúc màn hình của trẻ là trên 2 giờ mỗi ngày. Với thời lượng tiếp xúc màn
                    hình trên 2
