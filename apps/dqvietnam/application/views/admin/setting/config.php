<script type="text/babel">
  const App = () => {
        ...
        const onGetList = async (params = {}) => {
            setLoading(true);
            const data = await API_V2.ACCOUNT.GET(params);
            setAccounts(data);
            setLoading(false);
        }
        ...
        return <section className="content">
                ...
                <Spin spinning={isLoading}>
                    <Table
                        ...
                        columns={[
                            ...
                            {title: 'Email', dataIndex: 'username', key: 'username'},
                            {
                                title: 'Điểm số',
            ...
            <Modal
                ...
                <Form id="crudForm" onFinish={onFinish}
                    ...
                    <Form.Item rules={[{required: true, message: 'Ngày sinh bắt buộc!'}]} label="Ngày sinh"
                               name="birthday">
                    ...
                    <Form.Item label="Trường học" name="schools_id">
                        <Select
                            showSearch
