                    ...
                    <div class="col-md-6">
                        <div class="card card-default" style="border: solid 1px #337ab7;">
                            ...
                            <div class="card-body" style="padding: 10px;">
                                <form id="frmEdit" class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <select name="parent_id" id="parent_id" class="form-control item-menu">
                            ...
                            <div class="card-footer clearfix" style="padding: 10px;">
                                <button type="button" id="btnReset" class="btn btn-default"><i class="fa fa-refresh"></i> Reset Data</button>
...
<!-- /.content -->
<script>
    var url_ajax_load_parent_menu = '<?php echo site_url('admin/system_menu/ajax_load_parent_menu') ?>';
</script>
