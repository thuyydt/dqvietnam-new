...
<?php endif; ?>
<script>
    const {useState, useEffect, useRef, useForceUpdate, useMemo} = React;

    const {
        Descriptions, Drawer, Transfer, Typography, Badge, DatePicker,
        Modal, Skeleton, Input, Divider, Spin, Row,
        Upload, Progress, Checkbox, TreeSelect, Tabs, Tree, Space, Radio, message,
