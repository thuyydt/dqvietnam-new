...
<div class="form-group">
  ...
  <div class="input-group input-group-lg">
    ...
    <span class="input-group-addon" style="padding: 0;"><a href="<?php echo getImageThumb(); ?>" class="fancybox"><img src="<?php echo getImageThumb(); ?>" width="44" height="44" loading="lazy"/></a></span>
  </div>
</div>