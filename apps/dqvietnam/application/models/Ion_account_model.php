...
class Ion_account_model extends CI_Model
{
  ...
  public function register($identity, $password, $email = '', $additional_data = array(), $groups = array())
  {
    ...
    $data = array(
      ...
      //'full_name' => $additional_data['full_name'],
      'created_on' => time(),
      'active' => 1
    );
  ...
  public function login($identity, $password, $remember = FALSE)
  {
    ...
    $query = $this->db->select($this->identity_column . ', ' . $this->identity_alt_column . ', ' . $this->identity_phone_column . ', id, password, active, last_login, username, type, schools_id')
  ...
  public function login_remembered_user()
  {
    ...
    if (
      !get_cookie($this->config->item('identity_cookie_name', 'ion_account'))
