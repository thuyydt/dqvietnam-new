<?php
	...
	$moxieManagerConfig['filesystem.extensions'] = 'jpg,jpeg,png,ico, gif,html,htm,txt,docx,doc,pdf,mp3,mp4,flv,xls,xlsx,json';
	...
	$moxieManagerConfig['edit.extensions'] = 'jpg,jpeg,png,gif,html,htm,txt,json';
	...
	$moxieManagerConfig['view.extensions'] = 'jpg,jpeg,png,gif,html,htm,txt,pdf,json';
